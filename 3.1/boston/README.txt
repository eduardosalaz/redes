...
Tomado de Brownlee, J. (2016). Deep learning with Python. Gumroad, Melbourne. 

*******

El objetivo del ejercicio es escribir un código para construir un modelo
que sea capaz de pronosticar nuevos valores de precios.
Una vez logrado ese objetivo, se proporcionarán nuevos datos y se evaluará
